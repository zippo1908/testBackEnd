...
@ComponentScans(value = { @ComponentScan("com.groupc.pt.*"),@ComponentScan("com.groupc.pt.service") })
public class AppConfig {
   ...
   public LocalSessionFactoryBean getSessionFactory() {
      ...
      factoryBean.setPackagesToScan("com.groupc.pt.model");
